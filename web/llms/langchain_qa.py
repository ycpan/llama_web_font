...
class mymodel:
    def __init__(self):
        ...
        model_path="/devdata/home/user/panyongcan/Project/llama.cpp/llama2/13B-16K/ggml-model-q4_0.gguf", callbacks=[QueueCallback(self.q)], verbose=True, n_gpu_layers=n_gpu_layers, n_ctx=4096,temperature=0.5,top_k=40,top_p=0.9,max_tokens=2000,max_length=2000,suffix='[INST]',eps=1e-5,rope_freq_scale=0.25
        #model_path="/devdata/home/user/panyongcan/Project/llama.cpp/llama2/7B-16K/ggml-model-q4_0.gguf", callbacks=[QueueCallback(self.q)], verbose=True, n_gpu_layers=n_gpu_layers, n_ctx=4096,temperature=0.5,top_k=40,top_p=0.9,max_tokens=2000,max_length=2000,suffix='[INST]',eps=1e-5,rope_freq_scale=0.25
        #model_path="/devdata/home/user/panyongcan/Project/llama.cpp/llama2/7B/ggml-model-q4_0.bin", callbacks=[QueueCallback(self.q)], verbose=True, n_gpu_layers=n_gpu_layers, n_ctx=4096,temperature=0.5,top_k=40,top_p=0.9,max_tokens=2000,max_length=2000,suffix='[INST]',eps=1e-5
        #model_path="/devdata/home/user/panyongcan/Project/llama.cpp/llama2/1.3B/ggml-model-q4_0.bin", callbacks=[QueueCallback(self.q)], verbose=True, n_gpu_layers=n_gpu_layers, n_ctx=4096,temperature=0.5,top_k=40,top_p=0.9,max_tokens=2000,max_length=2000,suffix='[INST]',eps=1e-5
